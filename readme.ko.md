...
- [typesafe-sdk-js](https://github.com/typesafe-ai/typesafe-sdk-js) - 공식 TS/JS.
- [typesafe-sdk-python](https://github.com/typesafe-ai/typesafe-sdk-python) - 공식 Python.
- [system-one-adapter-python](https://github.com/typesafe-ai/system-one-adapter-python) - LLM 백엔드 drop-in.
- [skills](https://github.com/typesafe-ai/skills) - 공식 skills([@typesafeai](https://x.com/typesafeai/status/2100376436272173088)).
...
- [jev-ultrafast](https://github.com/browser-use/jev-ultrafast) - 플래그십. Flights ~7s/~$0.0039. X: [@gregpr07](https://x.com/gregpr07/status/2100411066966749359).
...
- [jev-browser-pilot](https://github.com/aidil2105/jev-browser-pilot) - 라이브러리형 pilot. 스타 낮고 구조는 탄탄.

**일단 제외:** 새 측정/X 없는 Ultrafast 얇은 래퍼(모바일 포함).

## 코딩 에이전트

- [fast-jev-compaction](https://github.com/tamaratran/fast-jev-compaction) - Claude Code compaction. 고스타/트렌드로 keep.
- [foreman](https://github.com/thruwire/foreman) - 팩토리 감독. X: [@JoshARosen](https://x.com/JoshARosen/status/2100573432089866717).
- [jev-review (devagrawal09)](https://github.com/devagrawal09/jev-review) - 단계 review. [@0xLogicrw](https://x.com/0xLogicrw/status/2100478725393686556).
- [jev-review (NiazMorshed2007)](https://github.com/NiazMorshed2007/jev-review) - MCP 우선 시.
- [pi-jev](https://github.com/y0usaf/pi-jev) / [pi-warden](https://github.com/DevMortimer/pi-warden) - Pi 게이트/가드레일.

## 라우터

- [jev-router](https://github.com/gargpratyush/jev-router) - 가장 많이 인용. X는 약해도 실용 keep.
- [hono-jev-router](https://github.com/yusukebe/hono-jev-router) - Hono 의미 라우터.

## 데이터 & 라이브러리

- [pg-jev](https://github.com/realZachi/pg-jev) - Postgres 확장. X 약·니치 실용 keep.

## 연구할 만한 데모

- [jev-trader](https://github.com/jarrodwatts/jev-trader) - Monad 블록 거래. X: [@jarrodwatts](https://x.com/jarrodwatts/status/2100356151468585346).
- [typesafe-mario](https://github.com/fhshaik/typesafe-mario) - 구조화 상태 Mario.
